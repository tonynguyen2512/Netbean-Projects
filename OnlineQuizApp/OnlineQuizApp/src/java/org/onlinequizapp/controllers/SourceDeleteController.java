 ...
 * @author User-PC
 */
@WebServlet(name = "SourceDeleteController", urlPatterns = {"/SourceDeleteController"})
public class SourceDeleteController extends HttpServlet {
        ...
        if (action.equals("Delete")) {
            try {
                if (!request.getParameter("status").equals("1")) {
                    ...
                    request.setAttribute("DELETE_ERROR", "Source is being used!");
                    url = SUCCESS;
                }
            } catch (Exception e) {
